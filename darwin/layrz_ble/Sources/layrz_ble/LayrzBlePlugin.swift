...
public class LayrzBlePlugin: NSObject, FlutterPlugin, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    static var checkScanPermissionsChannel: FlutterMethodChannel?
    static var checkAdvertisePermissionsChannel: FlutterMethodChannel?
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        checkScanPermissionsChannel = FlutterMethodChannel(name: "com.layrz.ble.checkScanPermissions", binaryMessenger: messenger)
        registrar.addMethodCallDelegate(instance, channel: checkScanPermissionsChannel!)
        checkAdvertisePermissionsChannel = FlutterMethodChannel(name: "com.layrz.ble.checkAdvertisePermissions", binaryMessenger: messenger)
        registrar.addMethodCallDelegate(instance, channel: checkAdvertisePermissionsChannel!)
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "checkScanPermissions":
            checkScanPermissions(result: result)
        case "checkAdvertisePermissions":
            checkAdvertisePermissions(result: result)
        case "startScan":
    ...
    private func checkScanPermissions(result: @escaping FlutterResult) {
        return checkCapabilities(result: result)
    }

    private func checkAdvertisePermissions(result: @escaping FlutterResult) {
        return result(false)
    }
